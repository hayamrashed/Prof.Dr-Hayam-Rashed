...
function fillPatientData(patient) {
  const setText = (id, value, isRich = false) => {
  ...
  setText("date_report_issued", patient.report_issued_date);
  setText("referred_by", patient.referred_by);
  setText("code_by", patient.code);

  // الحقول التي تحتوي على تنسيقات HTML
  setText("clinical_diagnosis", patient.clinical_data, true);
  setText("specimen_type", patient.specimen_information, true);
  setText("gross_picture", patient.gross_picture, true);
  setText("microscopic_picture", patient.microscopic_picture, true);
  setText("diagnosis", patient.diagnosis, true);
